 ...
 */
require([ "esri/map", 'dojo/on', 'dojo/dom', 'dojo/_base/fx', 'esri/layers/ArcGISTiledMapServiceLayer', "esri/geometry/Extent", "dojo/domReady!"],
    function (Map, on, dom,basefx, ArcGISTiledMapServiceLayer, Extent) {
        ...
        var graybasemapurl = "http://map.geoq.cn/ArcGIS/rest/services/ChinaOnlineStreetGray/MapServer";
        ...
        on(map,"layer-add-result",function(result){
          //在添加到地图上之后将最下面图层的display设置为none，以及透明度设置为0
